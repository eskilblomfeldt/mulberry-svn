...
// begin JXLayout
    ...
    itsOpenButton =
        new JXTextButton(JGetString("itsOpenButton::JXChoosePathDialog::JXLayout"), window,
                    JXWidget::kFixedRight, JXWidget::kFixedBottom, 219,279, 72,22);
    assert( itsOpenButton != NULL );
    itsOpenButton->SetShortcuts(JGetString("itsOpenButton::JXChoosePathDialog::shortcuts::JXLayout"));
    ...
    itsSelectButton =
        new JXTextButton(JGetString("itsSelectButton::JXChoosePathDialog::JXLayout"), window,
