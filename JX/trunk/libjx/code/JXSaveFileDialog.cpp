...
// begin JXLayout
    ...
    itsSaveButton =
        new JXTextButton(JGetString("itsSaveButton::JXSaveFileDialog::JXLayout"), window,
                    JXWidget::kFixedRight, JXWidget::kFixedBottom, 219,279, 72,22);
    assert( itsSaveButton != NULL );
    itsSaveButton->SetShortcuts(JGetString("itsSaveButton::JXSaveFileDialog::shortcuts::JXLayout"));
	...
	)
{
	...
	JXCSFDialogBase::SetObjects(
		...
		filterLabel, filterInput, filterHistory,
		itsSaveButton, upButton, homeButton, newDirButton, showHiddenCB,
