...
// Panes
const	PaneIDT		paneid_ServerFlatHierarchy = 'FLAT';

// Messages
const	MessageT	msg_ServerFlatHierarchy = 'FLAT';
...
public:
	...
	LBevelButton* GetHierarchyBtn() const
