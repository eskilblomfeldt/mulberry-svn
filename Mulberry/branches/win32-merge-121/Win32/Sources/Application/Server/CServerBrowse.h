...
public:
	...
	DECLARE_DYNCREATE(CServerBrowse)
...
protected:
	...
	void	SetTextStyle(CDC* pDC, CMboxProtocol* proto, bool directory, CMbox* mbox, bool& strike);		// Get appropriate text style
	bool 	UsesBackgroundColor(EServerBrowseDataType type) const;
	COLORREF GetBackgroundColor(EServerBrowseDataType type) const;
...
protected:
	...
	void	RemoveChildren(UInt32& parent_row, bool refresh = false);	// Remove child nodes from the list
