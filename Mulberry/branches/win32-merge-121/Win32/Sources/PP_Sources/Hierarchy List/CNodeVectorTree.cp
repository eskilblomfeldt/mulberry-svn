...
Boolean CNodeVectorTree::HasSibling(UInt32 inWideOpenIndex)
{
...
Boolean CNodeVectorTree::HasParent(UInt32 inWideOpenIndex)
{
	SHierarchyNode *node = mHierarchyArray.at(inWideOpenIndex - 1);
...
Boolean CNodeVectorTree::HasChildren(UInt32 inWideOpenIndex)
{
	SHierarchyNode *node = mHierarchyArray.at(inWideOpenIndex - 1);
