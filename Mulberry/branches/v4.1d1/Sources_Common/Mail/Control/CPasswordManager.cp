...
CPasswordManager* CPasswordManager::GetManager()
{
	if (sPasswordManager == NULL)
		sPasswordManager = new CPasswordManager();
...
void CPasswordManager::AddPassword(const CINETAccount* acct, const cdstring& pswd)
{
#if __dest_os == __mac_os_x
