...
const ResIDT		menu_AccountIMSPAdbk = 10;
const ResIDT		menu_AccountACAPAdbk = 11;
const ResIDT		menu_AccountLDAPSearch = 13;
const ResIDT		menu_AccountManageSIEVE = 15;
const ResIDT		menu_AccountCalDAVCalendar = 17;
const ResIDT		menu_AccountWebDAVCalendar = 18;
