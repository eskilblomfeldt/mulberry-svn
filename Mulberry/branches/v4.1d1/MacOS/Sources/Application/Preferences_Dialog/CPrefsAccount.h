...
const ResIDT		menu_AccountIMSPOptions = 7;
const ResIDT		menu_AccountACAPOptions = 8;
const ResIDT		menu_AccountCardDAVAdbk = 10;
const ResIDT		menu_AccountIMSPAdbk = 11;
const ResIDT		menu_AccountACAPAdbk = 12;
const ResIDT		menu_AccountLDAPSearch = 14;
const ResIDT		menu_AccountManageSIEVE = 16;
const ResIDT		menu_AccountCalDAVCalendar = 18;
const ResIDT		menu_AccountWebDAVCalendar = 19;
