...
void CChangePswdAcctDialog::FinishCreateSelf(void)
{
	...
	// Set up server name
	mAccountPopup = (LPopupButton*) FindPaneByID(paneid_ChangePswdAcctAcctPopup);
	mPluginPopup = (LPopupButton*) FindPaneByID(paneid_ChangePswdAcctPluginPopup);
...
void CChangePswdAcctDialog::GetDetails(CINETAccount*& acct, CPswdChangePlugin*& plugin)
{
	...
	cdstring pluginname = ::GetPopupMenuItemTextUTF8(mPluginPopup);
