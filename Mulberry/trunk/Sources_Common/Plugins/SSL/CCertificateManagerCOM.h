...
public:
	...
	virtual bool CheckUserCertificate(const cdstring& server, svector<int>& errors, X509* server_cert) = 0;
	virtual bool AcceptableUser(const cdstring& server, X509* server_cert, const svector<int>& errors, const cdstrvect& error_txt) = 0;
