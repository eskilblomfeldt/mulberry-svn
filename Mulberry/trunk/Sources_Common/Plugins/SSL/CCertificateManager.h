...
public:
	...
	bool CheckServerCertificate(const cdstring& server, svector<int>& errors, X509* server_cert);
	bool AcceptableServer(const cdstring& server, X509* server_cert, const svector<int>& errors, const cdstrvect& error_txt);
	...
	virtual bool CheckUserCertificate(const cdstring& email, svector<int>& errors, X509* user_cert);
	virtual bool AcceptableUser(const cdstring& email, X509* user_cert, const svector<int>& errors, const cdstrvect& error_txt);
